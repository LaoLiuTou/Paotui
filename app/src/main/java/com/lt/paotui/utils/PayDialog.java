...
public class PayDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbWxPay = (RadioButton) findViewById(R.id.rb_wx_pay);
        rbAliPay = (RadioButton)findViewById(R.id.rb_ali_pay);
        ivBalanceIcon = (ImageView) findViewById(R.id.iv_balance_icon);
        tvBalancePay = (TextView) findViewById(R.id.tv_balance);
        tvBalancePayContext = (TextView)findViewById(R.id.tv_balance_pay_context);
        tvBalance = (TextView)findViewById(R.id.tv_balance);
        rbBalancePay = (RadioButton) findViewById(R.id.rb_balance_pay);
        rlBalancePay = (RelativeLayout) findViewById(R.id.rl_balance_pay);
        btnPay = (Button) findViewById(R.id.btn_pay);
        rlWxPay = (RelativeLayout) findViewById(R.id.rl_wx_pay);
        rlAliPay = (RelativeLayout)findViewById(R.id.rl_ali_pay);
