...
public class LeavingListActivity extends Activity   {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        page=1;
        getTicketData(page,size);
        top_bar_title.setText("留言列表");
    }
    /**
     * 接收解析后传过来的数据
     */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(LeavingListActivity.this, msg.obj.toString(),Toast.LENGTH_LONG).show();
                    break;
                case 2:
    ...
    private void getTicketData(final int page,int size){
        xRefreshView.startRefresh();
        Map userInfo = JSON.parseObject(SPUtils.get(LeavingListActivity.this,"userinfo","{}").toString());
        ...
        FormBody formBody = new FormBody.Builder()
                ...
                .add("cus_id", cus_id)
                .build();
        Request request = new Request.Builder().url(Config.url+"/listTicket")
    ...
    private void initListView(){
        adapter = new LeavingAdapter(listData, this);
        // 设置静默加载模式
...
//        xefreshView1.setPreLoadCount(4);
        ...
        adapter.setOnItemClickListener(new LeavingAdapter.ItemClickListener() {
            @Override
            public void onItemClick(int position) {
                Intent intent = new Intent();
                intent.setClass(LeavingListActivity.this, LeavingDetailActivity.class);
