        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(CouponListActivity.this, msg.obj.toString(),Toast.LENGTH_LONG).show();
                    break;
                case 2:
...
//        xefreshView1.setPreLoadCount(4);
    ...
    public void btnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.addleaving:
                if((boolean)SPUtils.get(CouponListActivity.this,"islogin",false)){
                    Intent intent = getIntent();
                    String title = intent.getStringExtra("title");
                    String type = intent.getStringExtra("type");
    ...
    private void showUnloginDialog(){
        MyAlertDialog myAlertDialog = new MyAlertDialog(CouponListActivity.this).builder()
                .setTitle("未登录")
                .setMsg("即将前往登录")
